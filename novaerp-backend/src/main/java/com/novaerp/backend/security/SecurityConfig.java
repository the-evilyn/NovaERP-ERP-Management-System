    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/sales/orders").hasAnyRole("ADMIN", "USER")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/purchases/orders").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.POST, "/api/purchases/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/purchases/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/purchases/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/invoices/customers").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.POST, "/api/invoices/customer").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.POST, "/api/invoices/customers/from-sale-order/**").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.POST, "/api/invoices/customers/from-order/**").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.POST, "/api/invoices/customer/from-sale-order/**").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.POST, "/api/invoices/customer/from-order/**").hasAnyRole("ADMIN", "USER")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/payments/customer-invoices/**").hasAnyRole("ADMIN", "USER")
