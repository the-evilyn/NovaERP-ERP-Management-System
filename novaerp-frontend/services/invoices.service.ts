...
export async function payCustomerInvoice(id: number): Promise<CustomerInvoiceResponse> { const { data } = await api.post<CustomerInvoiceResponse>(`/invoices/customers/${id}/pay`); return data; }
...
export async function paySupplierInvoice(id: number): Promise<SupplierInvoiceResponse> { const { data } = await api.post<SupplierInvoiceResponse>(`/invoices/suppliers/${id}/pay`); return data; }
