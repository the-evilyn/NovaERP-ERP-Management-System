...
export function Input({
  ...
  const inputClassName = cn(
    "h-9.5 w-full min-w-0 rounded-[inherit] px-[calc(--spacing(3)-1px)] text-foreground leading-9.5 outline-none [transition:background-color_5000000s_ease-in-out_0s] placeholder:text-muted-foreground/72 sm:h-8.5 sm:leading-8.5 autofill:[-webkit-text-fill-color:var(--foreground)]",
    size === "sm" &&
